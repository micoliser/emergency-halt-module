...
- MetaMask + studionet (chain id **61999**, RPC `https://studio.genlayer.com/api`)
...
| `NEXT_PUBLIC_GENLAYER_RPC_URL` | browser | Default `https://studio.genlayer.com/api` |
| `NEXT_PUBLIC_CHAIN_ID` | browser | `61999` |
